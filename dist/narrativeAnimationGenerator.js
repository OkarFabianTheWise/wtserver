 ...
 */
function drawStickFigure(ctx, x, y, color = '#000', scale = 1) {
 ...
 */
function drawRectangle(ctx, x, y, width, height, fillColor, label = '', fontSize = 16) {
 ...
 */
function drawArrow(ctx, fromX, fromY, toX, toY, color = '#0066cc', width = 3, progress // 0..1 optional moving head progress
) {
    const headlen = 18;
 ...
 */
function drawCoin(ctx, x, y, radius = 20, color = '#FFD700') {
    ctx.fillStyle = color;
    ctx.beginPath();
 ...
 */
function renderSceneContent(ctx, scene, canvasWidth, canvasHeight, frameProgress = 1 // 0..1 within scene for simple animation
) {
 ...
 */
async function generateSceneFrames(scene, outputDir, startFrameIndex, canvasWidth = 1280, canvasHeight = 720, frameRate = 30) {
 ...
 */
export async function generateNarrativeVideo(scenes, audioPath, outputPath) {
 ...
 */
export async function generateNarrativeVideoBuffer(scenes, audioBuffer) {
...
//# sourceMappingURL=narrativeAnimationGenerator.js.map